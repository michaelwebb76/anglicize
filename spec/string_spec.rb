...
describe String do
  ...
  describe '.has_alternate_english_spelling?' do
    it 'returns true if a word can be replaced' do
      expect('Blue Is Warmest Color'.has_alternate_english_spelling?).to be true
    end

    it 'returns false if no words can be replaced' do
      expect('Aeon Colour'.has_alternate_english_spelling?).to be false
    end
  end

  describe '.has_altenate_american_spelling?' do
    it 'returns true if a word can be replaced' do
      expect('Blue Warmest Colour'.has_alternate_american_spelling?).to be true
    end

    it 'returns false if no words can be replaced' do
      expect('Eon Color'.has_alternate_american_spelling?).to be false
    end
  end
end
